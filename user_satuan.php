                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="id" id="id" class="form-control mt-2" value="<?= $data['id_satuan']; ?>" placeholder="ID Satuan" readonly required>
                                                            <label for="nama_satuan">Nama Satuan</label>
                                                            <input type="text" name="nama_satuan" id="nama_satuan" class="form-control mt-2" value="<?= $data['nama_satuan']; ?>" placeholder="Nama Satuan" readonly required>
                                                            <label for="ket">Keterangan</label>
                                                            <input type="text" name="ket_satuan" id="ket" class="form-control mt-2" value="<?= $data['ket_satuan']; ?>" placeholder="Ket. Merek" readonly>
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="hapusstnuser">Hapus</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" name="id" id="id" class="form-control mt-2" value="<?= $data['id_satuan']; ?>" placeholder="ID Satuan" readonly required>
                                                            <label for="nama_satuan">Nama Satuan</label>
                                                            <input type="text" name="nama_satuan" id="nama_satuan" class="form-control mt-2" value="<?= $data['nama_satuan']; ?>" placeholder="Nama Satuan" required>
                                                            <label for="ket">Keterangan</label>
                                                            <input type="text" name="ket_satuan" id="ket" class="form-control mt-2" value="<?= $data['ket_satuan']; ?>" placeholder="Ket. Merek">
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="ubahstnuser">Ubah</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                                                        </div>
                                                    </form>
                                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                <!-- Modal body -->
                <div class="modal-body">
                    <label for="namastn">Nama Satuan</label>
                    <input type="text" name="nama_satuan" id="namastn" class="form-control mt-2" placeholder="Nama Satuan" required>
                    <label for="ket">Keterangan</label>
                    <input type="text" name="ket_satuan" id="ket" class="form-control mt-2" placeholder="Ket. Merek">
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="tambahstnuser">Tambah</button>
