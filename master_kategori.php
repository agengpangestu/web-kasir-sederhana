                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" id="id" name="id" class="form-control mt-2" value="<?= $data['id_kategori']; ?>" placeholder="ID Kategori" readonly>
                                                            <label for="nama_kategori">Nama Kategori</label>
                                                            <input type="text" id="nama_kategori" name="nama_kategori" class="form-control mt-2" value="<?= $data['nama_kategori']; ?>" placeholder="Nama Kategori" readonly>

                                                            <label for="ket_kategori">Ket. Kategori</label>
                                                            <input type="text" id="ket_kategori" name="ket_kategori" class="form-control mt-2" value="<?= $data['ket_kategori']; ?>" placeholder="Ket. Kategori" readonly>
                                                        </div>
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="hapusktg">Hapus</button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <input type="text" id="id" name="id" class="form-control mt-2" value="<?= $data['id_kategori']; ?>" placeholder="ID Kategori" readonly>
                                                            <label for="nama_kategori">Nama Kategori</label>
                                                            <input type="text" id="nama_kategori" name="nama_kategori" class="form-control mt-2" value="<?= $data['nama_kategori']; ?>" placeholder="Nama Kategori" required>
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="ubahktg">Ubah</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                                                        </div>
                                                    </form>
                                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <div class="modal-body">
                    <label for="nama_kategori">Nama Kategori</label>
                    <input type="text" id="nama_kategori" name="nama_kategori" class="form-control mt-2" placeholder="Nama Kategori" required>

                    <label for="ket_kategori">Ket. Kategori</label>
                    <input type="text" id="ket_kategori" name="ket_kategori" class="form-control mt-2" placeholder="Ket. Kategori">
                </div>
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="tambahktg">Tambah</button>
