        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Button laporan -->
                    <a href="user_cetak_penjualan.php">
                        <button type="button" class="btn btn-secondary mb-4" onclick="return confirm('Ingin mencetak laporan?');">Laporan</button>
                    </a>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="btnuserhapus">Hapus</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="ubahuserpenjualan">Ubah</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Tutup</button>
                                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="btnusertambah">Tambah</button>
