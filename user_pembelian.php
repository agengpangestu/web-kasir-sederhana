        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Button laporan -->
                    <a href="user_cetak_pembelian.php" onclick="return confirm('Ingin mencetak laporan?');">
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!-- <a href=" #" class="btn btn-warning" onclick="return confirm('Ingin mengubah?');">Ubah</a> -->
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="hpsuserpembelian">Hapus</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form method="post">
                                                        ...
                                                        <!-- Modal footer -->
                                                        <div class="modal-footer">
                                                            <button type="submit" class="btn btn-success" name="ubahuserpembelian">Ubah</button>
                                                            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Batal</button>
                                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post">
                ...
                <!-- Modal footer -->
                <div class="modal-footer">
                    <button type="submit" class="btn btn-success" name="btnuserpembelian">Tambah</button>
