            ...
            <form method="post">
                ...
                <div class="modal-body">
                    ...
                    $ambil = mysqli_query($conn, "SELECT master_barang.id_barang,
                                                    ...
                                                    WHERE id_barang='$_GET[ubah]' ");
                    while ($data = mysqli_fetch_array($ambil)) :
                    ?>
                        <tr>
                            <label for="id_barang">ID Barang</label>
                            <td><input type="text" id="id_barang" name="id_barang" class="form-control mt-2" value="<?= $data['id_barang']; ?>" readonly placeholder="ID Barang"></td>
                        </tr>
                        <tr>
                            <label for="kode_barang">Kode Barang</label>
                            <td><input type="text" id="kode_barang" name="kode_barang" class="form-control mt-2" value="<?= $data['kode_barang']; ?>" readonly placeholder="Kode Barang"></td>
                        </tr>
                        <tr>
                            <label for="kategori">Kategori</label>
                            <td><select class="form-select mt-2" id="kategori" name="kategori">
                        ...
                        <tr>
                            ...
                            <td><input type="text" id="nama_barang" name="nama_barang" class="form-control mt-2" value="<?= $data['nama_barang']; ?>" placeholder="Nama Barang"></td>
                        </tr>
                        <tr>
                            <label for="harga">Harga Beli</label>
                            <td><input type="num" id="harga" name="harga" class="form-control mt-2" value="<?= $data['harga']; ?>" placeholder="Harga Beli"></td>
                        </tr>
                        <tr>
                            <label for="harga_jual">Harga Jual</label>
                            <td><input type="num" id="h_jual" name="h_jual" class="form-control mt-2" value="<?= $data['harga_jual']; ?>" placeholder="Harga Jual"></td>
                        </tr>
                ...
                <div class="modal-footer">
                    ...
                    <a href="index.php"><button type="button" class="btn btn-danger" data-bs-dismiss="modal">Tutup</button></a>
                </div>
